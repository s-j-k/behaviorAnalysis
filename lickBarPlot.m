function [pHit,pFA,hitLickRate,faLickRate,ohitLickRate,ofaLickRate]=lickBarPlot(hitLickRate,faLickRate,ohitLickRate,ofaLickRate,hitLickRateE,faLickRateE,ohitLickRateE,ofaLickRateE)
