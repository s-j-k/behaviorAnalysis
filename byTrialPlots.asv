function byTrialPlots(allDataTestsOnly,allLicksTest,days,reinfcolor,optocolor)
...
count=0;
    ...
    RTFHist=hist(lickLatRTT(:),bins)/(length(lickLatRTT)*6);
    ...
    subplot(2,3,4);plot(bins,RFTHist,'Color',reinfcolor,'LineWidth',2);xlim([-0.5 4]);
    xlabel('Time of first lick(s)');ylabel('Proportion of licks');
    subplot(2,3,5);plot(bins,FullTHist,'Color',optocolor,'LineWidth',2);xlabel('Time of first lick(s)');ylim([0 0.5]);xlim([-0.5 4]);
    subplot(2,3,6);plot(bins,CFTHist,'Color',optocolor,'LineWidth',2);xlabel('Time of first lick(s)');ylim([0 0.5]);xlim([-0.5 4]);
    ...
    subplot(2,3,4);plot(bins,RFFHist,'Color',reinfcolor,'LineWidth',2);ylim([0 0.5]);
    xlim([-0.5 4]);xlabel('Time of first lick(s)');ylabel('Proportion of licks');
    ...
    subplot(2,3,4);plot(bins,RTFHist,'Color',reinfcolor,'LineWidth',2);ylim([0 0.5]);
    xlim([-0.5 4]);xlabel('Time of first lick(s)');ylabel('Proportion of licks');
    subplot(2,3,5);plot(bins,ToneFHist,'Color',optocolor,'LineWidth',2);xlabel('Time of first lick(s)');ylim([0 0.5]);xlim([-0.5 4]);
    subplot(2,3,6);plot(bins,CFHist,'Color',optocolor,'LineWidth',2);xlabel('Time of first lick(s)');ylim([0 0.5]);xlim([-0.5 4]);
