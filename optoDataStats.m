...
%     aovMGBbyAn
    ...
    % this doesn't run with the real data yet, just dummy data
    % potential way to visualize the anova result 
...
%% plot catch trials
    ...
    for ww=1:length(animalIdx)
        animalNum=animalIdx(ww);
        animalRates=rates{animalNum,2}; % which animal are we plotting
